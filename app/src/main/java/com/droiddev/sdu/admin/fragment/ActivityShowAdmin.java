...
public class ActivityShowAdmin extends Fragment {

    private static final String ARG_PARAM1 = "data";
    private String data;

    public ActivityShowAdmin() {

    }

    public static ActivityShowAdmin newInstance(String data) {
        ActivityShowAdmin fragment = new ActivityShowAdmin();
